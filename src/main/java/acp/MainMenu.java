...
public class MainMenu implements ActionListener {
  ...
  protected JMenuBar createMenuBar() {
    ...
    JRadioButtonMenuItem rbEnglish = new JRadioButtonMenuItem(Messages.getString(menuTitle));
    ...
    JRadioButtonMenuItem rbRussian = new JRadioButtonMenuItem(Messages.getString(menuTitle));
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (actionComm.equals("connect")) {
      ...
      if (DbConnect.testConnection()) {
        ...
        boolean resInit = fileList.initForm();
        if (resInit) {
      ...
      if (DbConnect.testConnection()) {
        ...
        boolean resInit = otherLogs.initForm();
        if (resInit) {
      ...
      if (DbConnect.testConnection()) {
        ...
        boolean resInit = constList.initForm();
        if (resInit) {
      ...
      if (DbConnect.testConnection()) {
        ...
        boolean resInit = varList.initForm();
        if (resInit) {
      ...
      if (DbConnect.testConnection()) {
        ...
        boolean resInit = srcList.initForm();
        if (resInit) {
      ...
      if (DbConnect.testConnection()) {
        ...
        boolean resInit = cfgList.initForm();
        if (resInit) {
      ...
      if (DbConnect.testConnection()) {
        ...
        boolean resInit = tblList.initForm();
        if (resInit) {
